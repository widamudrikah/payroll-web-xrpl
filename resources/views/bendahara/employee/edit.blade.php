                ...
                <div class="card-body">
                    <form action="{{ route('manage.employee.update', $employee->id) }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="jabatan" id="jabatan" value="{{ old('name', $employee->jabatan) }}" class="form-control @error('jabatan') is-invalid @enderror" placeholder="Contoh: Staff, Admin, dll">
                            @error('jabatan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
